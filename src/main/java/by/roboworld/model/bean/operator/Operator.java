...
/**
 * The {@code Operator} is used to control robots. He creates them and assigns
 * tasks. He can include trackers to monitor for robots.
 */
public interface Operator {
     ...
     * empty {@code Map}. The returned {@code Map} is unmodifiable because
    ...
    /**
     * Creates and returns a new robot of the specified type. The created
     * robot will be started immediately. The name for a new robot will be
    ...
    /**
     * Creates and returns a new robot of the specified type and name. The
     * created robot will be started immediately. If the specified name is
     * {@code null} or empty, a unique random name will be generated. If the
     * robot with the specified name is already under the control of operator,
     * the {@code RobotAlreadyExistException} will be thrown.
     *
     * @param type type of the robot
     ...
     */
    void assignTask(Task task, String robotName);
