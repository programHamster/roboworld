...
public final class SharedBoard {
    ...
    /**
     * Returns and removes the first task of the board for the specified type
     * of the robot, or returns {@code null} if board hasn't a task for the
     * robot of the specified type. If board hasn't a task for the specified
     * type of the robot, it is searched in the general board because an any
     * robot can perform them.
     *
     * @param type type of robot
     * @return the first task of the board for specified type of robot, or
     *         {@code null} if this board is empty
     */
    ...
    /**
     * Retrieves, but does not remove, the first task of the board for the
     * specified type of the robot, or returns {@code null} if board hasn't a
     * task for the robot of the specified type. If board hasn't a task for the
     * specified type of the robot, it is searched in the general board because
     * an any robot can perform them.
     *
     * @param type type of robot
