 ...
 */
public abstract class AbstractSpecialRobot extends AbstractRobot
        implements SpecialRobot {

    /**
     * Takes tasks primarily from the queue of special tasks and only then
     * from general-purpose tasks.
     *
