...
public abstract class TaskFactory {
     ...
     *
     * This factory could be implemented not through a cycle, but through a switch, but then the user
     * would have to enter an additional parameter (type). I think that the cycle of a small number of
     * types of factories is a small fee for the convenience of using this factory.
     *
