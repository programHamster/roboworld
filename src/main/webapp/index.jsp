...
<div class="container">
    <div class="functional">
        ...
        <hr/>
        Create a new task :
        <form name="createTask" id="formCreateTask" method="post" >
            <br>
            <input type="hidden" name="<%=Constants.PARAM_NAME_COMMAND%>" value="<%=Constants.COMMAND_CREATE_TASK%>">
            <label>Select the implementation of task
        ...
        <hr/>
        Broadcast the task :
        <form name="giveTask" id="formGiveTask" method="post" >
            <br>
            ...
            <label>Select the task
                ...
                <label>assign to a particular robot(optional)
